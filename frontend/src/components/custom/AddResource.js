...
export default function AddResource() {
  ...
  return (
    <div className="bg-[#f5f8ff] rounded-2xl mt-20 p-6 relative w-full mx-auto">
      ...
      <h2 className="text-2xl font-bold mb-1">Add Resource</h2>
      <p className="text-sm text-gray-600 mb-6">Select course, add title, and upload a video</p>

      {/* Course Selection Dropdown */}
      <div className="mb-4">
        <Label htmlFor="course" className="mb-1 block">Select Course</Label>
        <select
          id="course"
