  ...
  return (
    <div className="bg-gray-100 px-4 py-2 sm:px-6 md:px-10 lg:px-20 mt-10">
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 p-4">
                  ...
                  <div className="bg-white rounded-lg p-4 w-full md:w-1/2 shadow-sm">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-xs text-gray-400">{new Date(course.createdAt).toLocaleDateString()}</span>
                    </div>
        ...
        {/* Calendar Section */}
        <div className="w-full bg-white p-6 rounded-xl shadow-sm border border-gray-200 h-[300px]">
          <Calendar />
        </div>
      </div>
    </div>
