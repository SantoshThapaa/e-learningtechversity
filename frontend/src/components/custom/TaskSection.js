...
const TaskPage = () => {
  ...
  const handleStudentSubmission = (taskId) => {
    router.push(`/teacher/studentsubmission/${taskId}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        {tasks.length > 0 ? (
          tasks.map((task) => (
            <div className="backdrop-blur-md p-6 rounded-lg shadow-md border border-gray-200 w-full" key={task._id}>
              ...
              <div className="space-y-4 mb-4 items-center justify-between">
                ...
                <button
                  onClick={() => handleStudentSubmission(task._id)}
