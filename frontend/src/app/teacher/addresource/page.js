...
export default function ResourcePage() {
  ...
  return (
    <div className="bg-[#f5f8ff] rounded-2xl p-6 relative w-full mx-auto">
      ...
      {/* Course Dropdown */}
      <div className="mb-4">
        <Label htmlFor="courseId" className="mb-1 block text-sm font-medium">Select Course</Label>
        {courses.length > 0 ? (
          <select
            id="courseId"
            value={courseId}
          ...
          <p className="text-sm italic text-red-500">No assigned courses found.</p>
        )}
      </div>
